                ...
                <div className='button-row'>
                    ...
                    <div className="button-group">
                            <button onClick={() => { videoContext.onSeek(-1) }}>
                                <svg xmlns="http://www.w3.org/2000/svg" title="Prev 1 Sec" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <button onClick={() => { videoContext.onSeek(-0.033) }}>
                                <svg xmlns="http://www.w3.org/2000/svg" title="Prev 1 Frame" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <button onClick={() => { videoContext.onSeek(0.033) }}>
                                <svg xmlns="http://www.w3.org/2000/svg" title="Next 1 Frame" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            ...
                            <button onClick={() => { videoContext.onSeek(1) }}>
                                <svg xmlns="http://www.w3.org/2000/svg" title="Next 1 Sec" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
