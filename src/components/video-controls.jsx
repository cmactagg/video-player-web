    ...
    return (
        <>
            <div className="flyout tab-content" id={"overlayButtonsVideoControl" + videoContext.index} style={displayStyle}>
                ...
                <div className="button-column">
                    <button title="Rotate CW 90" onClick={() => videoContext.onRotate(90)}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            viewBox="0 0 16 16">
                            <path fillRule="evenodd"
                                d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2z"></path>
                            ...
                            <line x1="8" y1="5" x2="8" y2="11" stroke="white" strokeWidth="2"></line>
                            <line x1="5" y1="8" x2="11" y2="8" stroke="white" strokeWidth="2"></line>
                        </svg>
                    </button>
                    <button title="Rotate CCW 90" onClick={() => videoContext.onRotate(-90)}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            viewBox="0 0 16 16">
                            <path fillRule="evenodd"
                                d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2z"></path>
