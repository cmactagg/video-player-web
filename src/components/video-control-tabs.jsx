...
const VideoControlTabs = ({isActive}) => {
    ...
    return (
        <>
            <div className="menu" id={"menu" + videoContext.index} >
            {/* <div className="flyout tab-content" id={"overlayButtonsTabs" + videoContext.index} style={displayStyle}> */}
                    ...
                    <button title="TBD Button 2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        {videoContext.playerCount > 1 && (
                            <>
                                ...
                                <button title="Close Player" onClick={(e) => videoContext.closePlayer(e)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
